...
*/
var scores, roundScore, activePlayer, gamePlaying, maxScore, firstHitDiceOne, secondHitDiceOne, firstHitDiceSecond, secondHitDiceSecond;
var i = 0;

var diceOne = document.querySelector('.dice');
...
document.querySelector('.btn-roll').addEventListener('click', function(){
  ...
  if(gamePlaying) {
    ...
    if( (i % 2) !== 0) {
     ...
     firstHitDiceSecond = diceSecond;
    } else {
     secondHitDiceOne = dice;
     secondHitDiceSecond = diceSecond;
    }
...
document.querySelector('.btn-add').addEventListener('click', function() {
  ...
  var input = document.querySelector('.add-input').value;
